...
puts "create lists"
list = List.create(name: "hollywood")
list2 = List.create(name: "classics")

puts "create bookmarks"
Bookmark.create(comment: "heard from friend", list_id: list.id, movie_id: movie.id)
Bookmark.create(comment: "searched from google", list_id: list.id)
Bookmark.create(comment: "recommend by A", list_id: list2.id)
Bookmark.create(comment: "recommend by B", list_id: list2.id)
